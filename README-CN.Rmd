---
title: "MicrobiomeStat: 支持R中的纵向微生物组分析"
...
📢 **更新** (10月20日): Shiny界面现已正式上线，目前支持小型至中型数据集的分析。您可以通过[此链接](https://a95dps-caffery-chen.shinyapps.io/MicrobiomeStat_Shiny/)访问界面。
...
- `microbiomeutilities`, `phyloseq`, `microbiomemarker`, `MicrobiomeAnalyst`, `microbiomeeco`, `EasyAmplicon`, `STAMP`, `qiime2`, 和 `MicrobiotaProcess`
...
如果您对特定函数的文档有特定的评论或问题，而您发现RStudio的搜索框导致404错误，您可以直接在[https://cafferychen777.github.io/MicrobiomeStat/reference/index.html](https://cafferychen777.github.io/MicrobiomeStat/reference/index.html)访问函数的文档。
...
## 加入我们的Discord社区 {#discord-community}

...
The `MicrobiomeStat` package is a dedicated R tool crafted with an emphasis on exploring **longitudinal microbiome data**. While it also offers the flexibility to engage with multi-omics data and cross-sectional studies, its essence is enriched by the facilitation of longitudinal analysis. This attribute aims to support researchers navigating through extensive biological inquiries over time.
...
- **Imported Packages:**
  - ggplot2, matrixStats, parallel, ggrepel, lmerTest, foreach, modeest, vegan, dplyr, pheatmap, tidyr, ggh4x, ape, GUniFrac, scales, stringr, broom
- **Suggested Packages:**
  - rmarkdown, knitr, ggprism, aplot, philentropy, forcats, pander, tinytex

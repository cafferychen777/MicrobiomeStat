utils::globalVariables(c(
  ...
  "arrange", "as", "as.dist", "as.formula", "as_tibble", "assay", "assays", "dplyr::bind_cols", "bind_rows",
  ...
  "dplyr::group_by", "group_by_at", "group_time", "hcl", "dplyr::if_else", "dplyr::inner_join", "is", "is.rooted",

utils::globalVariables(c(
  ...
  "joint_factor", "joint_factor_numeric", "knit_expand", "lag", "last", "ldply", "dplyr::lead",
  ...
  "pivot_wider", "plot_fun", "prevalence", "prevalence_change", "pt", "dplyr::pull", "quantile",
  ...
  "subset_data", "dplyr::summarise", "dplyr::summarize", "summarize_all", "t.level", "temp", "term",

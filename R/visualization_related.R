utils::globalVariables(c(
  ...
  "TimePoint", "Variable", "ZicoSeq", "abundance_change", "across", "adj.vars", "all_of", "anova", "any_of",
  "arrange", "as", "as.dist", "as.formula", "as_tibble", "assay", "assays", "bind_cols", "bind_rows",
  ...
  "cumulative_value", "ddply", "desc", "dev.off", "df", "distance", "distinct", "drop.tip", "estimate",
  "everything", "experiments", "exprs", "fData", "facet_nested", "facet_nested_wrap", "fct_relevel",
  "feature", "feature_tab", "full_join", "gather", "get_fun_from_pkg", "grid.echo", "group",
  "group_by", "group_by_at", "group_time", "hcl", "if_else", "inner_join", "is", "is.rooted",
  "joint_factor", "joint_factor_numeric", "knit_expand", "lag", "last", "ldply", "lead",
  "left_join", "lm", "mean_abundance", "mean_value", "median", "metaMDS", "meta_tab", "method",
  "midpoint", "min_half_value", "model.matrix", "mutate", "mutate_at", "n", "na.omit",
  "new_count", "next_cumulative_mean_value", "next_cumulative_value", "one_of",
  "otu_table", "p.adjust", "p.value", "pData", "par", "pdf", "pheatmap", "pivot_longer",
  "pivot_wider", "plot_fun", "prevalence", "prevalence_change", "pt", "pull", "quantile",
  "read.csv", "read.nexus", "read.table", "read.tree", "read_biom", "rename", "replace_na",
  "rowData", "rowMaxs", "rowSds", "rownames_to_column", "rowwise", "rrarefy", "sample_data",
  "sample_metadata", "sd", "separate", "setNames", "show_mothur_cutoffs", "spread",
  "starts_with", "statistic", "std.error", "strata.var", "subject", "subject.var",
  "subset_data", "summarise", "summarize", "summarize_all", "t.level", "temp", "term",

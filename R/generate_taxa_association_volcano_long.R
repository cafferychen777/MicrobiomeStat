...
#' @param palette (optional) A color palette for the plot, can be a predefined palette name or a vector of color codes.
#'                If not provided, a default color palette will be used. The palette should be in a format accepted by ggplot2.

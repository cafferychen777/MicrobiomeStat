...
#' @param test.list A list of test results from `generate_beta_change_test_long` function, representing the statistical analysis of beta diversity over time.
...
#' result1 <- generate_beta_test_long(
#'   data.obj = ecam.obj,
#'   beta.name = c("shannon", "simpson", "observed_species", "pielou"),
#'   time.var = "month_num",
...
#' result2 <- generate_beta_test_long(
#'   data.obj = subset_T2D.obj,
#'   beta.name = c("shannon", "simpson", "observed_species", "chao1", "ace", "pielou"),
...
#' }
#' @export
generate_beta_dotplot_long <- function(data.obj,
                                        test.list,
                                        group.var,
                                        time.var,
                                        t0.level,

#' Generate Report Section Functions for Longitudinal Analysis
#'
#' Internal helper functions that generate R Markdown content for each
#' section of the longitudinal microbiome analysis report.
#' These functions return template strings that are combined by
#' mStat_generate_report_long() to create the complete report.
#'
#' @name report_section_generators
#' @keywords internal
NULL


#' Generate YAML Header for Report
#' @noRd
generate_report_yaml_header <- function(yaml_output) {
  paste0("
---
...
#' Generate Section 1: Data Overview and Summary Statistics
#' @noRd
generate_report_section_overview <- function() {
'
...
```{r taxa-heatmap-longitudinal-indiv-print, echo=FALSE, message=FALSE, results=result.output, fig.align=\'center\', fig.width = 30, fig.height = 15, warning = FALSE}
...
```{r taxa-change-heatmap-longitudinal-generation, message=FALSE, fig.align=\'center\', fig.width = 15, fig.height = 8, results=\'hide\', warning = FALSE}
...
```{r taxa-barplot-longitudinal-generation, message=FALSE, fig.align=\'center\', fig.width = 15, fig.height = 8, results=\'hide\', warning = FALSE}
...
```{r taxa-barplot-longitudinal-print, echo=FALSE, message=FALSE, results=result.output, fig.align=\'center\', fig.width = 20, fig.height = 15, warning = FALSE}
cat(\'The following plots display the average proportions for each time point, group, and stratum. \\n\\n\')
...
#' Generate Section 2: Alpha Diversity Analysis
#' @noRd
generate_report_section_alpha <- function() {
'
...
#' Generate Section 3: Beta Diversity Analysis
#' @noRd
generate_report_section_beta <- function() {
'
...
#' Generate Section 4: Feature-level Analysis
#' @noRd
generate_report_section_taxa <- function() {
'
